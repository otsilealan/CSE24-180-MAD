...
**Primary Dependencies**: Room Database, Jetpack Compose, ViewModel, Coil (image loading), WorkManager 
...
**Constraints**: <100MB app size, local-only data (no backend)  
...
2. Add dependencies: Room, Coil, WorkManager
