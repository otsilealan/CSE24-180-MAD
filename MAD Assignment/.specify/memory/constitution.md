...
- Extension Feature: Either campus navigation OR chat system, fully integrated
...
- Local database: Room DB (Android) or SQLite (Flutter)
...
- Password hashing (bcrypt/SHA-256) - no plain text storage
...
### UI/UX Standards
- Material Design (Android) or equivalent modern framework
